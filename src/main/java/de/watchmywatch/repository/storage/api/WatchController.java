...
public class WatchController {
    ...
    void deleteWatch(@PathVariable Integer id) {
    ...
    public @ResponseBody
    @ResponseStatus(HttpStatus.NO_CONTENT)
    void deleteBracelet(@PathVariable Integer id) {
    ...
    public @ResponseBody
    @ResponseStatus(HttpStatus.NO_CONTENT)
    void deleteCasing(@PathVariable Integer id) {
    ...
    public @ResponseBody
    @ResponseStatus(HttpStatus.NO_CONTENT)
    void deleteClockwork(@PathVariable Integer id) {
